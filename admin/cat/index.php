...
<script type="text/javascript">
    document.title = "Category | VinaEnter Edu";
</script>
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            //Tổng số dòng
                            if (!isset($find)) {
                                $qrTsd = "SELECT * FROM cat";
                            } else {
                                $qrTsd = "SELECT * FROM cat WHERE name LIKE '%$find%' ";
                            }
                            ...
                            ?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        if (!isset($find)) {
                                            $qr = "SELECT * FROM cat LIMIT {$offset},{$row_count}";
                                        } else {
                                            $qr = "SELECT * FROM cat WHERE name LIKE '%$find%' LIMIT {$offset},{$row_count}";
                                        }
                                        ...
                                        ?>
                                            <tr class="gradeX">
                                                ...
                                                <td class="center">
                                                    <a href="edit.php?id=<?php echo $row['cat_id']; ?>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                                    <a href="del.php?id=<?php echo $row['cat_id']; ?>" title="" class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
