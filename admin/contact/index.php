                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            if (!isset($find)) {
                                ...
                                $qrTsd = "SELECT * FROM contact WHERE name LIKE '%$find%' OR email LIKE '%$find%'";
                            }
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="gradeX">
                                                ...
                                                <td class="center">
                                                    <a href="del.php?id=<?php echo $row['contact_id']; ?>" title="" class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
