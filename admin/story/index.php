                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            //Tổng số dòng
                            if (!isset($find)) {
                                $qrTsd = "SELECT s.*,c.name AS cname FROM story AS s INNER JOIN cat AS c ON s.cat_id = c.cat_id";
                            } else {
                                $qrTsd = "SELECT s.*,c.name AS cname FROM story AS s INNER JOIN cat AS c ON s.cat_id = c.cat_id WHERE s.name LIKE '%$find%' OR c.name LIKE '%$find%'";
                            }
                            ...
                            ?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        if (!isset($find)) {
                                            $qr = "SELECT s.*,c.name AS cname FROM story AS s INNER JOIN cat AS c ON s.cat_id = c.cat_id ORDER BY s.story_id DESC LIMIT {$offset},{$row_count}";
                                        } else {
                                            $qr = "SELECT s.*,c.name AS cname FROM story AS s INNER JOIN cat AS c ON s.cat_id = c.cat_id WHERE s.name LIKE '%$find%' OR c.name LIKE '%$find%' ORDER BY s.story_id DESC LIMIT {$offset},{$row_count}";
                                        }
                                        ...
                                        ?>
                                            <tr class="gradeX">
                                                ...
                                                <td class="center">
                                                    <a href="edit.php?story_id=<?php echo $story_id ?>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                                    <a href="del.php?story_id=<?php echo $story_id ?>" title="" class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
