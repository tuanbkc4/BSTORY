...
// -- truy vấn--
$qrDelComment = "DELETE FROM comment WHERE comment_id = '$comment_id';";
$result = $conn->query($qrDelComment);
$qrDelComment = "DELETE FROM sub_comment WHERE comment_id = '$comment_id';";
$result = $conn->query($qrDelComment);
?>
<!-- ------ -->
<hr />
