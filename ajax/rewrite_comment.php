...
// truy vấn
$qrGetComment = "SELECT content FROM comment WHERE comment_id = '$comment_id'";
...
<form action="javascript:void(0)" class="form_comment" method="post">
    ...
    ?>
    <input type="text" name="content" id="" class="contentComment mainComment" value="<?php echo $content; ?>">
    <input class="updateComment" type="submit" name="submit" value="<?php echo  $_POST['comment_id'] ?>">
</form>