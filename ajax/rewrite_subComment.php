...
// truy vấn
$qrGetComment = "SELECT content FROM sub_comment WHERE sub_comment_id = '$sub_comment_id'";
...
?>
<li>
    <form action="javascript:void(0)" class="activeSubComment form_comment sub formComment-<?php echo $comment_id; ?>" method="post">
        <?php
        ...
        ?>
        <input type="text" name="contentSub" id="" class="contentSubComment-<?php echo $comment_id; ?>" value="<?php echo $content; ?>">
        <input class="updateSubComment" type="submit" name="submit" value="<?php echo $_POST['comment_id'] . '-' . $_POST['sub_comment_id']; ?>">
    </form>
</li>
