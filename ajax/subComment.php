...
// -- truy vấn--
if ($content != "") {
    $qrAddComment = "INSERT INTO sub_comment(comment_id,user_id,content,create_at,user_liked,counter_like) VALUES ($comment_id, $user_id, '$content','$datetime','',0)";
    $result = $conn->query($qrAddComment);
}
?>
<!-- --------- -->
<?php
